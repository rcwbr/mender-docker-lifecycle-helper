...
class TestArtifactMetadataInit:
    """Tests for the ArtifactMetadata __init__ method"""

    def test_init_with_version_and_services(self):
        """Test ArtifactMetadata initialization with version and services."""
        version = "1.0.0"
        services = {"serviceA": {"image": {"ref": "my-image:latest", "hash": "abc123"}}}
...
class TestFromDict:
    """Tests for the ArtifactMetadata from_dict method"""
    ...
    def test_from_dict_basic(self):
        ...
        data = {
            "version": "2.0.0",
            "services": {
                "serviceB": {"image": {"ref": "nginx:alpine", "hash": "def456"}}
            },
        }
    ...
    def test_from_dict_with_empty_services(self):
        """Test ArtifactMetadata.from_dict with empty services."""
        data = {"version": "3.0.0", "services": {}}
        metadata = ArtifactMetadata.from_dict(data)
        assert metadata.version == data["version"]
        assert metadata.services == data["services"]

    def test_from_dict_with_missing_services(self):
    ...
    def test_from_dict_with_missing_version(self):
        ...
        data = {
            "services": {
                "serviceC": {"image": {"ref": "redis:latest", "hash": "ghi789"}}
            }
        }
        metadata = ArtifactMetadata.from_dict(data)
...
class TestFromFile:
    """Tests for the ArtifactMetadata from_file method"""
    ...
    def test_from_file_basic(self, tmp_path):
        ...
        data = {
            "version": "5.0.0",
            "services": {
                "serviceD": {"image": {"ref": "postgres:13", "hash": "jkl012"}}
            },
        }
...
class TestToDict:
    """Tests for the ArtifactMetadata to_dict method"""

    def test_to_dict_roundtrip(self):
        """Test that to_dict produces the expected structure."""
        version = "6.0.0"
        services = {
            "serviceE": {"image": {"ref": "mongo:5.0", "hash": "mno345"}},
            "serviceF": {"image": {"ref": "elasticsearch:8.0", "hash": "pqr678"}},
        }
        metadata = ArtifactMetadata(version, services)
...
class TestToFile:
    ...
    def test_to_file_creates_directories(self, tmp_path):
