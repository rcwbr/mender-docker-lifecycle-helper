...
[![Conventional Commits](https://img.shields.io/badge/conventional_commits-compliant-pink?style=flat-square&logo=conventionalcommits&logoColor=white)](https://www.conventionalcommits.org/en/v1.0.8/)
...
```bash
wget -qO - https://raw.githubusercontent.com/rcwbr/mender-docker-lifecycle-helper/refs/tags/1.0.8/mender-docker-lifecycle-helper-launcher | bash -s -- --help
```
...
docker run \
	...
	ghcr.io/rcwbr/mender-docker-lifecycle-helper:1.0.8 \
	--help
```
...
jobs:
  mender-docker-lifecycle-helper:
    uses: 
      rcwbr/mender-docker-lifecycle-helper/.github/workflows/mender-docker-lifecycle-helper.yaml@1.0.8
    with:
...
jobs:
  mender-docker-lifecycle-helper:
    uses: rcwbr/mender-docker-lifecycle-helper/.github/workflows/mender-docker-lifecycle-helper.yaml@1.0.8
    with:
...
| `helper-image`              | ✗        | `'ghcr.io/rcwbr/mender-docker-lifecycle-helper:1.0.8'` | string | Docker image to use as mender-docker-lifecycle-helper.                                                                               |
...
[conventional commit messages](https://www.conventionalcommits.org/en/v1.0.8/) as the standard for
