...
```bash
wget -qO - https://raw.githubusercontent.com/rcwbr/mender-docker-lifecycle-helper/refs/tags/0.3.1/mender-docker-lifecycle-helper-launcher | bash -s -- --help
```
...
docker run \
	...
	ghcr.io/rcwbr/mender-docker-lifecycle-helper:0.3.1 \
	--help
```
...
jobs:
  mender-docker-lifecycle-helper:
    uses: 
      rcwbr/mender-docker-lifecycle-helper/.github/workflows/mender-docker-lifecycle-helper.yaml@0.3.1
    with:
...
jobs:
  mender-docker-lifecycle-helper:
    uses: rcwbr/mender-docker-lifecycle-helper/.github/workflows/mender-docker-lifecycle-helper.yaml@0.3.1
    with:
...
| `helper-image`              | ✗        | `'ghcr.io/rcwbr/mender-docker-lifecycle-helper:0.3.1'` | string | Docker image to use as mender-docker-lifecycle-helper.                                                                     |
